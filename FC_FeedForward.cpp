...
Matrix* AutoEncoder::FC_FeedForward(Mode mode, int ThreadNum)
{
    /*ARGUMENT LIST*/
...

void AutoEncoder::Bottleneck_FeedForward(int ThreadNum)
{
	/*ARGUMENT LIST*/
	int L = Arg->numOfLayers;
	bool batchNorm = Arg->batchNorm;
	...
	layer* layers = Arg->layers;
	float* keep_prob = Arg->keep_prob;
	string ActivationsPath = Arg->ActivationsPath;
	/*END OF ARGUMENT LIST*/
	...
	/*BEGINNING OF THE Sparse_FeedForward*/
	for (int i = 0; i < (L - 1) / 2; i++)
	{
		...
		FC_Cache[ThreadNum].put(CharGen("A", i + 1), A);
		if (i == ((L - 1) / 2) - 1 && Arg->SaveActivation)
		{
			A->Write(ActivationsPath);
			cout<<"A["<<DP->curFile+1<<"] " << "is stored in "<< Arg->ActivationsPath <<endl;
		}
	}
	/*END OF Sparse_FeedForward*/
	temp1 = A->SUM("column");
	delete Arg->Rho_hat;
	Arg->Rho_hat = temp1->div(A->Columns());
	delete temp1;
}
