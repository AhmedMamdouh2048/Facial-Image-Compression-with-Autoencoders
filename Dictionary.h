...
public:
	...
	void DeleteThenClearTEST();                                 //deletes allocated elements then removes all entries in the dictionary (Matrix) [IT DOES NOT DELETE THE X_TEST MATRIX]
	...
	void Write(string path);									//write the dictionary contents in hard disk
	void Read(string);											//read the dictionary contents from hard disk
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename K, typename V>
void Dictionary<K, V>::DeleteThenClearTEST()
{
    BItor X_test = find("A0");
	for (BItor i = bkt.begin(); i != bkt.end(); ++i)
	{
	    if(i != X_test)
        {
...
const V& Dictionary<K, V>::operator[](K key)
{
	...
	std::cout << "This key " << key << " does not exist!" << std::endl << std::endl;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename K, typename V>
void Dictionary<K, V>::Read(string path)
{
	for (BItor i = bkt.begin(); i != bkt.end(); ++i)
	{
		string s = path;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename K, typename V>
void Dictionary<K, V>::Write(string path)
{
	for (BItor i = bkt.begin(); i != bkt.end(); ++i)
	{
		string s = path;
